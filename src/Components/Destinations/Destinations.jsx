  ...
  return (
    <section className="py-16 bg-gray-50 text-center">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-4xl font-bold text-gray-800 mb-6">Choose Your Destination</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {destinations.map((item, index) => (
            ...
            >
              ...
              {/* Card Content */}
              <div className="absolute inset-0 flex flex-col justify-center items-center  p-4 opacity-100 group-hover:opacity-100 transition duration-300">
                <h3 className="text-2xl font-semibold text-white">{item.name}</h3>
                <p className="text-lg mt-2 text-white">{item.description}</p>
