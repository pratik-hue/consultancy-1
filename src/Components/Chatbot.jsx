...
const Chatbot = () => {
  ...
  return (
    <div className="fixed bottom-10 right-8 flex flex-col items-end z-50">
      {/* Floating Chatbot Icon with Space from the Screen */}
      <button
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="w-80 bg-white shadow-lg rounded-lg border border-gray-300 mt-3"
          >
            {/* Chat Header */}
